...
SYMMAP = {
    ...
    'Conn_GH4':      ('Connector_Generic', 'Conn_01x04'),
...
GROUPS = [
  ...
  [('U1','STM32F103C8T6','STM32F103C8T6'), ('R10','R','10k'), ('C19','C','100nF'),
   ('R9','R','10k'), ('C25','C','100nF'), ('R12','R','100k'), ('R13','R','47k')],
  # 电机驱动 + 支撑
  ...
  # 卫星板接口 (AS5600 / MPU6050 不在本板上, 见 encoder_board / imu_board)
  [('J6','Conn_GH4','ENC1'), ('J7','Conn_GH4','IMU->ENC2')],
  # CAN / USB / SWD / 板间堆叠
...
NETS = {
 # ---- 电源树 ----
 # J1 -> SW1 总开关 -> D1 防反接(串联) -> VIN, 再经板间 J8 上供主控板
 "BAT_RAW": [("J1","1"),("SW1","1")],
 "SW_OUT":  [("SW1","2"),("D1","A")],
 "VIN":     [("D1","K"),("U2","Vs"),("U3","Vs"),("U7","IN"),
 ...
 # ---- 卫星板接口 (GH1.25 4P: 1=+3V3 2=SCL 3=SDA 4=GND) ----
 # J6 -> 左轮编码器板
 # J7 -> IMU 板 -> 右轮编码器板 (I2C2 串接, 与参考项目一致)
 "I2C1_SCL": [("U1","PB6"),("J6","2")],
 "I2C1_SDA": [("U1","PB7"),("J6","3")],
 "I2C2_SCL": [("U1","PB10"),("J7","2")],
 "I2C2_SDA": [("U1","PB11"),("J7","3")],
 "CAN_RX":  [("U1","PA11"),("U9","RXD")],
 "CAN_TX":  [("U1","PA12"),("U9","TXD")],
 "CAN_H":   [("U9","CANH"),("R8","1"),("J8","5")],
 "CAN_L":   [("U9","CANL"),("R8","2"),("J8","6")],
 "UART2_TX": [("U1","PA2"),("U10","RXD")],
 "UART2_RX": [("U1","PA3"),("U10","TXD")],
 "SWDIO":   [("U1","PA13"),("J4","1")],
 "SWCLK":   [("U1","PA14"),("J4","2")],
 "FB":      [("U7","FB"),("R2","1"),("R3","1")],
 # 电池分压: 8.4V * 47/(100+47) = 2.69V < 3.3V
 "BAT_DIV": [("R12","1"),("R13","1"),("U1","PA0")],
}
