...
- [x] 参考项目分析 + 架构设计
- [x] 固件算法（FOC/PID/LQR平衡/CAN，6 套主机测试全绿）
- [x] F103 驱动板固件（FOC + 平衡 + yaw + CAN，编译通过）
- [x] F407 主控板固件（STS3032 腿 + CAN 主机，编译通过）
- [x] 双板网表 + 校验通过
- [x] 上电联调方案（docs/bringup_plan.md）
- [ ] 画双板原理图（按 netlist.py 逐线连接）
- [ ] 双板 PCB + 打样
- [ ] 上电联调
